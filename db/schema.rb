...
ActiveRecord::Schema.define(version: 2019_07_23_125838) do
  ...
  create_table "product_attribute", primary_key: ["product_id", "attribute_value_id"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
    t.integer "product_id", null: false
    t.integer "attribute_value_id", null: false
  end

  create_table "product_category", primary_key: ["product_id", "category_id"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci", force: :cascade do |t|
    t.integer "product_id", null: false
